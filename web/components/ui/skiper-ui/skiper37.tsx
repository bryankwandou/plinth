...
/**
 * Plinth adaptation of AnimatedNumber_004: counts from 0 to `value` with NumberFlow
 * the first time it scrolls into view. NumberFlow honours prefers-reduced-motion.
 */
export function InViewNumber({
  value,
  decimals = 0,
  suffix = "",
  className,
  ...
  return (
    <span ref={ref} className={className}>
      <NumberFlow
        ...
        transformTiming={{ duration: 1100, easing: "cubic-bezier(.2,.7,.2,1)" }}
        spinTiming={{ duration: 1100, easing: "cubic-bezier(.2,.7,.2,1)" }}
      />
    </span>
  );
}
